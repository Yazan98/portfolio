                            ...
                            <div className={"ServiceItem"}>
                                <div className="ProjectComponentContainer">
                                    <div className="ProjectItem">
                                        ...
                                        <h5>Exposer</h5>
                                        <p className="Description">Android Domain Layer Controller Via UseCases To Handle Shared Logic Between Android, IOS Via Kotlin Multiplatform With Reactive Programming, Memory, etc</p></div>
                                </div>
                            </div>
                            ...
                            <div className={"ServiceItem"}>
                                <div className="ProjectComponentContainer">
                                    <div className="ProjectItem">
                                        ...
                                        <h5>Groupy</h5>
                                        <p className="Description">Graduation Project Android Application Built With Kotlin Coroutines, Firebase Realtime Database, Firebase Auth, Notifications, Mvp</p></div>
                                </div>
                            </div>
                            ...
                            <div className={"ServiceItem"}>
                                <div className="ProjectComponentContainer">
                                    <div className="ProjectItem">
                                        <p>Backend Side</p>
                                        <h5>Bookie</h5>
                                        <p className="Description">Books Api Powered By SpringBoot, Java, MySql, Swagger-ui, Error Handling</p></div>
                                </div>
                            </div>
                            ...
                            <div className={"ServiceItem"}>
                                <div className="ProjectComponentContainer">
                                    <div className="ProjectItem">
                                        <p>Frontend Side</p>
                                        <h5>Atto</h5>
                                        <p className="Description">Android Library To Build Mvp Applications with a Lot Of Utils (Archived)</p></div>
                                </div>
                            </div>
